# open-bridge 对三个参照项目：取了多少、是否更强

判定日期：2026-09-12 ｜ 对象：`DesktopCommanderMCP`、`devspace`、`taskquay`（本地克隆目录）
沿用仓库内既有的对照基线：`open-bridge/docs/refactor-comparison.md`（512 行，含 D1–D9 / T1–T7 / M1–M3 清单）
...
| | **open-bridge** | DesktopCommanderMCP | devspace | taskquay |
| --- | --- | --- | --- | --- |
