...
import { pruneSessions, startSessionPruneLoop } from "../sessions/session-table.js";
import { legacySessionProblem } from "./session-guidance.js";
import { openLegacySession, resumeLegacySession } from "../sessions/session-resume.js";
import { touchSessionTicket } from "../sessions/session-store.js";
import { publishSelf, readablePeerFiles, startRepublishLoop } from "../tunnel/peer-registry.js";
import { selfProbe } from "../lifecycle/self-probe.js";
...
export async function startHttpInternal(): Promise<void> {
  ...
  // self-connection is a shutdown bug (see src/bridge/lifecycle/self-probe.ts).
