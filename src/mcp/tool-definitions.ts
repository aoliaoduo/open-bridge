...
const ACTIVITY_LOG_OUTPUT_SCHEMA = {
  oneOf: [
    ARRAY_RESULT_SCHEMA(ACTIVITY_ROW_SCHEMA, "recent returns activity rows in items."),
    {
      ...
      required: ["entries", "total_scanned", "truncated"],
      properties: {
