...
export async function buildSettingsState(): Promise<SettingsState> {
  ...
  return {
    ...
    config: {
      ...
      "notify.soundAttention": cfg.get("notify.soundAttention", CONFIG_DEFAULTS["notify.soundAttention"] as string),
      "notify.soundWaiting": cfg.get("notify.soundWaiting", CONFIG_DEFAULTS["notify.soundWaiting"] as string),
      "notify.soundFinished": cfg.get("notify.soundFinished", CONFIG_DEFAULTS["notify.soundFinished"] as string),
      "notify.soundProgress": cfg.get("notify.soundProgress", CONFIG_DEFAULTS["notify.soundProgress"] as string),
...
function fallbackState(): SettingsState {
  return {
    ...
    config: {
      ...
      "notify.soundAttention": CONFIG_DEFAULTS["notify.soundAttention"] as string,
      "notify.soundWaiting": CONFIG_DEFAULTS["notify.soundWaiting"] as string,
      "notify.soundFinished": CONFIG_DEFAULTS["notify.soundFinished"] as string,
      "notify.soundProgress": CONFIG_DEFAULTS["notify.soundProgress"] as string,
