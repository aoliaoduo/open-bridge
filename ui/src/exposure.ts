 ...
 * before being merged here. `label`/`note` serve the 状态 page chip, `text`
 * the 安全 page overview.
 */
export interface ExposureMeta {
  /** Short chip text on the 状态 page. */
  label: string;
  /** One-line note under the 状态 page chip. */
  note: string;
